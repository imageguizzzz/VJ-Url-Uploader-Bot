...
class Config(object):
    # Bot Information 
    TECH_VJ_BOT_TOKEN = os.environ.get("TECH_VJ_BOT_TOKEN", "7453769576:AAGh8CDXW1DaHvj-2BYn7TfE07-aAkl4mUA")
    TECH_VJ_BOT_USERNAME = os.environ.get("TECH_VJ_BOT_USERNAME", "Guizzzzzzbot") # Bot username without @.
    
    # The Telegram API things
    TECH_VJ_API_ID = int(os.environ.get("TECH_VJ_API_ID", "2902346"))
    TECH_VJ_API_HASH = os.environ.get("TECH_VJ_API_HASH", "b905c9901a26f5c16d09731ad5f14178")
    ...
    TECH_VJ_OWNER_ID = int(os.environ.get("TECH_VJ_OWNER_ID", "843779477")) 
    ...
    # channel information
    TECH_VJ_LOG_CHANNEL = int(os.environ.get("TECH_VJ_LOG_CHANNEL", "6918558739")) # your log channel id and make bot admin in log channel with full right 
